        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-dark" aria-current="page">{{ trans('messages.lienhe') }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="name">{{ trans('messages.hoten') }}"</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="subject" name="title" placeholder="{{ trans('messages.tieude') }}">
                                    <label for="subject">{{ trans('messages.tieude') }}</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="message" name="content" style="height: 120px"></textarea>
                                    <label for="message">{{ trans('messages.noidung') }}</label>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2633.3381300109527!2d105.8006620617952!3d21.028584430207808!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac9f07337671%3A0x3738d875d489a9a5!2sVINICORP%20-%20Viet%20Nhat%20General%20JSC!5e0!3m2!1svi!2s!4v1701421682105!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
