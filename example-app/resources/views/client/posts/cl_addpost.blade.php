...
<body id="page-top">
                                    ...
                                    <div class="card-body p-md-5">
                                        <div class="row justify-content-center">
                                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                                ...
                                                <form action="{{route('cl_save_addpost')}}" method="POST" class="was-validated" id="form-add-post" enctype="multipart/form-data">
                                                    @csrf
    ...
    <script>
        ...
        datePicker.addEventListener('change', function() {
            ...
            if (selectedDate === '') {
                // Nếu không có ngày nào được chọn, đặt ngày mặc định là hôm nay
                var today = new Date();
            ...
            datePicker.min = today; // Đặt giá trị min thành ngày hiện tại
        });
    </script>
