        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item text-dark" aria-current="page">{{ trans('messages.postsbydate') }} {{ $date }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6">{{ trans('messages.postsbydate') }} {{ $date }}</h1>
            </div>
            <div class="row g-4">
                @if(count($posts) > 0)
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="store-item position-relative text-center">
                        ...
                        <div class="store-overlay">
                            <a href="{{route('chitiet',$post->id)}}" class="btn btn-primary rounded-pill py-2 px-4 m-2">More Detail <i class="fa fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <p style="text-align: center; margin-top: 30px; color: red; font-size: 20px;">Không có bài viết nào cho ngày {{$date}}</p>
                @else
                <p style="text-align: center; margin-top: 30px; color: red; font-size: 20px;">There are no posts for the day {{$date}}</p>
                @endif
                @endif
                <div>
                    {{$posts->links()}}
