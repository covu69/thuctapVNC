    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <form action="{{route('save_info')}}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="title" id="title" value="{{$in->title}}" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Type</label>
                                <input type="number" class="form-control" id="type" name="type" value="{{$in->type}}" readonly>
                            </div>
                        </div>
                ...
                <a href="{{route('info')}}" style="padding: 2%;"><i style="font-size:24px" class="fa">&#xf122;</i></a>
                </form>
            </div>
