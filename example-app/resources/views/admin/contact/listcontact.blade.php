            ...
            <div id="content">
                ...
                <div class="container-xl">
                    <div class="form-group">
                        <form action="{{route('lh_search')}}" method="get">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="{{route('deleteSelectd_contact')}}" method="post">
                            @csrf
                            @method('DELETE')
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h2>Manage admin <b>Contact</b></h2>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <table class="table table-striped table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="custom-checkbox">
                                                <input type="checkbox" id="checkbox1" name="ids[{{$contact->id}}]" value="{{$contact->id}}">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{route('show_contact',$contact->id)}}" style="padding: 2%;"><i style="font-size:24px" class="fa">&#xf06e;</i></a>
                                                <a href="{{route('xoa_contact',$contact->id)}}" onclick="return confirm('Bạn có chắc muốn xóa không?')"><i class="fa fa-trash"></i></a>
                                            </div>
