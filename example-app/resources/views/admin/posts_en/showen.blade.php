                        ...
                        <div class="col-md-10 mx-auto">
                            <div class="contact-form">
                                ...
                                <form action="/examples/actions/confirmation.php" method="post">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" readonly class="readonly-input" id="inputName" value="{{$post->title}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                    ...
                                    <a href="{{route('post')}}" style="padding: 2%;"><i style="font-size:24px" class="fa">&#xf122;</i></a>
                                </form>
                            </div>
                        </div>
                    </div>
