                                    ...
                                    <div class="col-md-8">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{route('post')}}" onclick="updateButtonText('Vi')">Vi</a>
                                                <a class="dropdown-item" href="{{route('index_en')}}" onclick="updateButtonText('En')">En</a>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-danger"><i class="material-icons">&#xE15C;</i> <span>Delete</span></button>
                                        <a href="{{route('add_post')}}" class="btn btn-success"> <span>Add Post</span></a>
                                    </div>
                                </div>
                            </div>
                            <!-- </div> -->
                            ...
                            <table class="table table-striped table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="custom-checkbox">
                                                <input type="checkbox" id="checkbox1" name="ids[{{$post->id}}]" value="{{$post->id}}">
                                        ...
                                        <td>
                                            <img src="{{asset('upload/post/'.$post->thumbnail)}}" width="100px" height="100px" alt="">
                                        </td>
                                        <td>{{$post->public_at}}</td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{route('show_en',$post->id)}}" style="padding: 2%;"><i style="font-size:24px" class="fa">&#xf06e;</i></a>
                                                <a href="{{route('edit_posten',$post->id)}}" style="padding: 2%;"><i class="fa fa-pencil"></i></a>
                                                <!-- <form action="{{route('destroy_post',$post->id)}}" method="post" type="button">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="btn btn-danger m-0" style="padding: 2%"><i class="fa fa-trash"></i></button>
                                                </form> -->
                                                <a href="{{ route('destroy_post', ['id' => $post->id]) }}" onclick="return confirm('Bạn có chắc muốn xóa bài viết này không?')"><i class="fa fa-trash"></i></a>
                                            </div>
