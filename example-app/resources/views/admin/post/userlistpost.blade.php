                            ...
                            <table class="table table-striped table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($post->status == 0)
                                            <button type="button" class="btn btn-danger">Đang đợi phê duyệt</button>
                                            @else
                                            <button type="button" class="btn btn-success">Đã phê duyệt</button>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="{{route('pheduyet',['id' => $post->id] )}}">Duyệt</a>
                                                <a href="{{route('show_tt',$post->id)}}" style="padding: 2%;"><i style="font-size:24px" class="fa">&#xf06e;</i></a>
                                                <!-- <a href="{{route('edit_post',$post->id)}}" style="padding: 2%;"><i class="fa fa-pencil"></i></a> -->
                                                ...
                                                <a href="{{ route('xoa', ['id' => $post->id]) }}" onclick="return confirm('Bạn có chắc muốn xóa bài viết này không?')"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
